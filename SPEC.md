...
`วันนี้` · `เดือนนี้` · `สรุป` · `รายงาน` · `หมวด กิน` (เจาะหมวด) · `ค้นหา กาแฟ` · `งบ` (สถานะงบทุกหมวด) · `/cats` (ดูหมวดทั้งหมด — กันลืมตอนตั้งงบ) · `/review` (เปิดหน้าเว็บจัดหมวดรายการที่ยังลง "อื่นๆ" → เลือกหมวดแล้วบอทจำให้)

**D. ตั้งค่า (ขึ้นต้น `/`):**
`/setbook บ้านเรา` · `/book` · `/budget กิน 5000` · `/cat ชานม = กิน > เครื่องดื่ม` (สอนหมวด) · `/digest on 21:00` (สรุปอัตโนมัติ) · `/export` · `/tz Asia/Bangkok` · `/help`
